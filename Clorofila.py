...
def avaliar_combinacao(X_train, X_test, y_train, y_test, n_lvs=3):
    ...
    try:
        ...
        # PLSRegression sem parâmetro random_state (compatibilidade com versões antigas)
...
def otimizar_bandas_por_r2(X, y, colunas_bandas, min_bandas=3, max_bandas=None, 
    ...
    Retorna:
    - resultados: DataFrame com todas as combinações testadas
    - melhor_combo: tuple com os índices das melhores bandas
    - melhor_modelo: modelo PLSR treinado com as melhores bandas
    - melhor_r2: melhor valor de R² obtido
    """
    ...
    for n_bandas in range(min_bandas, max_bandas + 1):
        ...
        for combo_indices in combinations(range(len(colunas_bandas)), n_bandas):
            ...
            # Selecionar bandas (usando reset_index para evitar problemas de indexação)
    ...
    return df_resultados, melhor_combo, melhor_modelo, melhor_r2, melhor_rmse, melhor_bandas
...
def plotar_top_combinacoes(df_resultados, top_n=10):
    ...
    sns.barplot(data=top_df, x=range(len(top_df)), y='r2', palette='viridis')
...
if __name__ == "__main__":
    ...
    df_resultados, melhor_combo, melhor_modelo, melhor_r2, melhor_rmse, melhor_bandas = otimizar_bandas_por_r2(
